                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="moduleForm" name="moduleForm" class="form-horizontal"
                              action="update.htm?id=${sysModule.id }" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="parent_id" type="hidden" name="parent_id" readonly="readonly"
                                           class="col-xs-10 col-sm-5" placeholder="" value="${sysModule.parent_id }">
                                    <input id="parent_name" type="text" name="parent_name" readonly="readonly"
                                           class="col-xs-10 col-sm-5" placeholder="" value="${sysModule.parent_name }">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                    <select name="target" class="col-xs-10 col-sm-5">
                                        <option value="main" <c:if
                                                test="${sysModule.target eq 'main'} "> selected</c:if>>main
                                        </option>
                                        <option value="blank" <c:if
                                                test="${sysModule.target eq 'blank'} "> selected</c:if>>blank
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="iconImg" type="text" name="iconImg" class="col-xs-10 col-sm-5"
                                           placeholder="" value="${sysModule.iconImg }"><label
                                        id="iconImgTip"></label>
                                </div>
                            </div>
                            <div class="form-group">
