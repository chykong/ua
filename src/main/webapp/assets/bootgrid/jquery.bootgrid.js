...
//            cell: "<td class=\"{{ctx.css}}\" style=\"padding-top: 4px; padding-bottom: 4px;\">{{ctx.content}}</td>",
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row\"><div class=\"col-lg-6 col-md-7 col-sm-7 col-xs-12\"><p class=\"{{css.pagination}}\"></p></div><div class=\"col-lg-6 col-md-5 col-sm-5 col-xs-12 infoBar\"><p class=\"{{css.infos}}\"></p></div></div></div>",
